...
class BirdsTilesAdapter(DatasetAdapter):
    """
    Tile-level adapter for raw/birds/ (original per-tile view, kept for rollback).

    Unit of analysis is the individual tile image. Prefer BirdsAdapter (birds.py)
    for the image-level view that aligns with all other datasets.
    ...
    * Unit of analysis is the tile (200×200 for DSC5214, 160×160 for DSC5295).
